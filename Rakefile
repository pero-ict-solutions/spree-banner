...
desc 'Generate documentation for the banner extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'BannerExtension'
...
desc 'Test the banner extension.'
...
namespace :test do
  desc 'Functional test the banner extension.'
  ...
  desc 'Unit test the banner extension.'
